...
import (
	...
	"github.com/paxosglobal/go-ethereum-optimism/trie/triestate"
)
...
func (s *StateDB) StartPrefetcher(namespace string, witness *stateless.Witness) {
	...
	// https://github.com/paxosglobal/go-ethereum-optimism/issues/29880
...
func (s *StateDB) Copy() *StateDB {
	...
	for addr := range s.journal.dirties {
		// As documented [here](https://github.com/paxosglobal/go-ethereum-optimism/pull/16485#issuecomment-380438527),
