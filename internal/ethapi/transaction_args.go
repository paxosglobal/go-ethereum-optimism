...
type TransactionArgs struct {
	...
	// Issue detail: https://github.com/paxosglobal/go-ethereum-optimism/issues/15628
...
func (args *TransactionArgs) setFeeDefaults(ctx context.Context, b Backend, head *types.Header) error {
	...
	// other tx values. See https://github.com/paxosglobal/go-ethereum-optimism/pull/23274
