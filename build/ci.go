...
func buildFlags(env build.Environment, staticLinking bool, buildTags []string) (flags []string) {
	...
	if env.Tag != "" {
		ld = append(ld, "-X", "github.com/paxosglobal/go-ethereum-optimism/version.gitTag="+env.Tag)
	}
...
func doCheckBadDeps() {
	baddeps := [][2]string{
		...
		{"github.com/paxosglobal/go-ethereum-optimism/core/rawdb", "github.com/paxosglobal/go-ethereum-optimism/ethdb/leveldb"},
		{"github.com/paxosglobal/go-ethereum-optimism/core/rawdb", "github.com/paxosglobal/go-ethereum-optimism/ethdb/pebbledb"},
	}
